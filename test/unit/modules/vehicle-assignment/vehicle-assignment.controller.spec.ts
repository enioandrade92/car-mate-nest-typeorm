...
describe('VehicleAssignmentController', () => {
	...
	describe('1 - register method', () => {
		it('1.1 - should return a register', async () => {
			mockAssignmentService.register.mockReturnValueOnce(mockRegisters[0]);
	...
	describe('2 - registerFinish method', () => {
		it('2.1 - should return a register', async () => {
			...
			const response = await controller.registerFinish(mockCreateRegister);
	...
	describe('3 - findByVehicleId method', () => {
		it('3.1 - should return a registers', async () => {
			mockAssignmentService.findByVehicleId.mockReturnValueOnce(mockRegisters);
	...
	describe('4 - findByDriverId method', () => {
		it('4.1 - should return a registers', async () => {
			mockAssignmentService.findByDriverId.mockReturnValueOnce(mockRegisters);
	...
	describe('5 - findByDriverName method', () => {
		it('5.1 - should return a registers', async () => {
			mockAssignmentService.findByDriverName.mockReturnValueOnce(mockRegisters);
