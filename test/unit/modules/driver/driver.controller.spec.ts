...
describe('DriverController', () => {
	...
	describe('2 - update method', () => {
		it('2.1 - should return a updated driver', async () => {
			...
			const response = await controller.updateDriver('1', mockUpdateDriver);
	...
	describe('3 - findAll method', () => {
		it('3.1 - should return a drivers', async () => {
			...
			const response = await controller.findDriverByFilters(mockFilterDriver);
	...
	describe('4 - findOne method', () => {
		it('4.1 - should return a drivers', async () => {
			mockDriverService.findDriverById.mockResolvedValueOnce(mockDriver[0]);
